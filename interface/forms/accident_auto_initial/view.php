...
<tr><td class='sectionlabel'><input type='checkbox' id='form_cb_m_1' value='1' data-section="Accident" checked="checked" />Accident </td></tr><tr><td><div id="Accident" class='section'><table>
<!-- called consumeRows 014--> <!--  generating 4 cells and calling --><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Accident and Injury Description','e').':'; ?></td><td class='text data' colspan='3'><?php echo generate_form_field($manual_layouts['description'], $xyzzy['description']); ?></td><!--  generating empties --><td class='emptycell' colspan='1'></td></tr>
<!-- called consumeRows 014--> <!-- just calling --><!-- called consumeRows 224--> <!--  generating 4 cells and calling --><td>
<span class="fieldlabel"><?php xl('Accident Date','e'); ?> (yyyy-mm-dd): </span>
</td><td>
   <input type='text' size='10' name='date_accident' id='date_accident' title='Accident date/Symptom first appear'
...
<td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Claim number','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_form_field($manual_layouts['claim_number'], $xyzzy['claim_number']); ?></td><!--  generating empties --><td class='emptycell' colspan='1'></td></tr>
<!-- called consumeRows 014--> <!-- just calling --><!-- called consumeRows 224--> <!--  generating 4 cells and calling --><td>
<span class="fieldlabel"><?php xl('Symptom first appeared','e'); ?> (yyyy-mm-dd): </span>
</td><td>
   <input type='text' size='10' name='date_symptom' id='date_symptom' title='When did Symptoms first appear?'
    value="<?php $result=chkdata_Date($xyzzy,'date_symptom'); echo $result; ?>"
    onkeyup='datekeyup(this,mypcc)' onblur='dateblur(this,mypcc)' />
   <img src='../../pic/show_calendar.gif' width='24' height='22'
    id='img_date_symptom' alt='[?]' style='cursor:pointer'
    title="<?php xl('Click here to choose a date','e'); ?>" />
<script type="text/javascript">
Calendar.setup({inputField:'date_symptom', ifFormat:'%Y-%m-%d', button:'img_date_symptom'});
</script>
</td>
<td>
<span class="fieldlabel"><?php xl('First visit for this Accident','e'); ?> (yyyy-mm-dd): </span>
</td><td>
   <input type='text' size='10' name='date_visit1' id='date_visit1' title='When did Patient first consult you for this condition'
    value="<?php $result=chkdata_Date($xyzzy,'date_visit1'); echo $result; ?>"
    onkeyup='datekeyup(this,mypcc)' onblur='dateblur(this,mypcc)' />
   <img src='../../pic/show_calendar.gif' width='24' height='22'
    id='img_date_visit1' alt='[?]' style='cursor:pointer'
    title="<?php xl('Click here to choose a date','e'); ?>" />
<script type="text/javascript">
Calendar.setup({inputField:'date_visit1', ifFormat:'%Y-%m-%d', button:'img_date_visit1'});
</script>
</td>
