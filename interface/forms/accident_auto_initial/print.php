...
<tr><td class='sectionlabel'><input type='checkbox' id='form_cb_m_1' value='1' data-section="Accident" checked="checked" />Accident </td></tr><tr><td><div id="print_Accident" class='section'><table>
...
<span class="fieldlabel"><?php xl('Accident Date','e'); ?>: </span>
</td><td>
...
<!-- called consumeRows 014--> <!-- just calling --><!-- called consumeRows 224--> <!--  generating 4 cells and calling --><td>
<span class="fieldlabel"><?php xl('Symptom first appeared','e'); ?>: </span>
</td><td>
...
<td>
<span class="fieldlabel"><?php xl('First visit for this Accident','e'); ?>: </span>
</td><td>
