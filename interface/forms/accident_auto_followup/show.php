...
<tr><td class='sectionlabel'>Initial Visit Information</td><tr><td class='sectionlabel'>Current Changes</td><!-- called consumeRows 014--> <!-- called consumeRows 224--> <td class='fieldlabel' colspan='1'><?php echo xl_layout_label('Same condition prior?','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_display_field($manual_layouts['same_condition'], $xyzzy['same_condition']); ?></td><td class='fieldlabel' colspan='1'><?php echo xl_layout_label('If YES, when and describe','e').':'; ?></td><td class='text data' colspan='1'><?php echo generate_display_field($manual_layouts['same_text'], $xyzzy['same_text']); ?></td></tr>
